...
c = ase.db.connect('rocksalt_exciting.db')

preferred_rmt = 2.00

kptdensity = 8.0  # this is converged
width = 0.01
...
from ase.lattice import bulk
# find minimal distances in fcc
rmt_max = {}
for name in fcc.keys():
    d = 100.0
    A = bulk(name, 'fcc', a=fcc[name]).repeat((2,2,2))
...
code = 'exciting' + '-' + 'r' + str(rgkmax) + '_g' + str(gmaxvr)
code = code + '_k' + str(kptdensity) + '_w' + str(width)
code = code + '_l' + str(lmaxapw) + str(lmaxvr) + str(lmaxmat)
code = code + '_r' + str(preferred_rmt) + '_r' + str(relativistic)
...
for name in names:
    ...
    kwargs = {
        ...
        'do':'fromscratch',
        'CoreRelativity':relativistic,
        'ValenceRelativity':relativistic,
        'useDM':'true',
        }
