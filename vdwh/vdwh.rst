...
This database contains the dielectric building blocks of 2D materials, that can be used to calculate the dielectric function of van der Waals heterostructures. 
...
The data  must be downloaded and used together with e.g. the Python script ``qeh.py`` as shown below.

* Download raw data :download:`chi-data.tar.gz`

* `Browse data <http://cmrdb.fysik.dtu.dk/'
